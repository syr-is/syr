 ...
 */
import { decodePublicKey, encodeMultibase, ED25519_MULTICODEC_PREFIX } from "./wasm-adapter.js";
...
export function personaIdFromPublicKey(publicKeyMultibase: string): string {
	...
	const prefixed = new Uint8Array(ED25519_MULTICODEC_PREFIX.length + rawBytes.length);

...
| Profile stories (24h reel, UTC storage, public API) | **Planned**     | Spec: [Profile stories (v1)](/architecture/profile-stories). Target: `GET /api/public/stories/{did}`, keys `uploads/{did}/stories/{UTC_YYYY-MM-DD}/public/…`, home tray + fullscreen viewer, client aggregation per follow row.                                                                                                                               |
